  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex">
      ...
      <nav class="nav-menu d-none d-lg-block">
       <ul>
       <li class="active"><a href="history.php">History</a>
          <li ><a href="dashboard.php">Dashboard</a>
          
          <li class="drop-down"><a href="#priorities">Admin</a>
            <ul>
 ...
 <section  class="services section-bg" >
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-right">
          ...
          <p>Appointment Dashboard<br> List of appointments from the dashboard.</p>
        </div>
                        ...
                        <?php
                            ...
                            if($resultChecked > 0){  
                                while($row = mysqli_fetch_assoc($result)){
                                    if("Pending" === $row['bookingStatus'] || "Accepted" === $row['bookingStatus'] || "Declined" === $row['bookingStatus'] || "Done" === $row['bookingStatus']){ ?>

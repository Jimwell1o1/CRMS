!(function () {
  ...
  var e = {
      ...
      143: function (e, t) {
        Object.defineProperty(t, "i", { value: !0 }), (t.o = void 0);
        var n = (function () {
          function e() {}
          return (
            (e.get = function (e) {
      ...
      730: function (e, t) {
        Object.defineProperty(t, "i", { value: !0 }), (t.v = void 0);
        var n = (function () {
          function e() {}
          return (
      ...
      447: function (e, t, n) {
        Object.defineProperty(t, "i", { value: !0 }), (t.t = void 0);
        var i = n(572),
          l = n(4),
          a = n(143),
          r = n(11),
          ...
          c = (function () {
            function e() {
              (this.content = a.o.get("content")),
                (this.location = new r.p(
            ...
            return (
              ...
              (e.prototype.A = function () {
                ...
                if (((e.innerHTML = i.default), this.location.M))
                  document.body.className = "dpw-no-sidebar";
                else {
                  var t = a.o.h(e, "menu"),
                    n = this.j();
                  t.appendChild(n),
                ...
                (this.placeholder = m),
                  h.l.m
                    ? m.appendChild(this.content)
                    : m.appendChild(this.content.content),
                  new s.P(this.placeholder).D(),
                  document.body.insertBefore(e, document.body.firstChild),
                  this.search.g(),
                  this.location.G && !this.location.sandbox && this.k.g();
              }),
              (e.prototype.j = function () {
                ...
                var n = a.o.create("ul"),
                  i = this.location.O;
                return (
                  this.C.getItems(i).forEach(function (t) {
                    var i = t.filename;
              ...
              (e.prototype.R = function () {
                var e = this,
                  ...
                  r = this.J(l, n + i, this.location.M);
                return (
                  t.appendChild(r.div),
                  this.C.L().forEach(function (l) {
                    var a = "" + n + l.O + "/" + i,
                      r = l.O === e.location.O,
                      m = e.J(l.text, a, r);
                    t.appendChild(m.div);
      ...
      11: function (e, t) {
        Object.defineProperty(t, "i", { value: !0 }), (t.p = void 0);
        var n = (function () {
          function e(e, t, n) {
            (this.N = ["demo", "demo2", "sandbox"]),
              (this.pathname = n),
              (this.host = t),
              (this.protocol = e),
              this.V();
          ...
          return (
            ...
            (e.prototype.V = function () {
              (this.filename = this.B(this.pathname)),
                (this.O = this.F(this.pathname)),
                (this.sandbox = this.q(this.pathname)),
                (this.G = this.K(this.host)),
                (this.filesystem = this.$(this.protocol));
            }),
      ...
      463: function (e, t, n) {
        Object.defineProperty(t, "i", { value: !0 }), (t.S = void 0);
        var i = n(143),
          l = (function () {
            function e() {
              this.U = null;
            ...
            return (
              ...
              (e.prototype.te = function () {
                if (null == this.U) {
                  var e = this.ne();
                  e &&
                    ((this.U = e.offsetHeight),
                    (e.style.height = this.U + "px"));
                }
              }),
              ...
              (e.prototype.ae = function () {
                ...
                a.l.m
                  ? (((e = i.o.create("div")).innerHTML =
                      "<pre>" + l.me.re(t.innerHTML) + "</pre>"),
                    this.placeholder.appendChild(e))
                  : (((e = i.o.create("pre")).innerText = l.me.re(t.innerText)),
                    this.placeholder.appendChild(e));
              }),
        ...
        var n = [
            {
              ...
              children: [
                ...
                { text: "API" },
                { text: "Angular", filename: "angular2.html" },
                { text: "AngularJS", filename: "angularjs.html" },
                {
                  text: "AngularJS (Controller As)",
                  filename: "angularjsctrlas.html",
                },
                { text: "jQuery", filename: "jquery.html" },
                { text: "View Types" },
            ...
            },
            {
              ...
              children: [
                ...
                { text: "Keyboard Access", filename: "keyboard.html", H: !0 },
                ...
                { text: "Gantt" },
                { text: "Gantt", filename: "gantt.html" },
                { text: "API" },
                { text: "Angular", filename: "angular2.html" },
                { text: "AngularJS", filename: "angularjs.html" },
                {
                ...
                { text: "Event Icons", filename: "eventicons.html", H: !0 },
                {
                ...
                { text: "Queue", filename: "queue.html", H: !0 },
                {
                ...
                { text: "Frozen Rows", filename: "rowsfrozen.html", H: !0 },
      ...
      827: function (e, t) {
        Object.defineProperty(t, "i", { value: !0 }), (t.me = void 0);
        var n = (function () {
          function e() {}
          return (
            (e.re = function (e) {
  ...
  (n.r = function (e) {
    "undefined" != typeof Symbol &&
      ...
      Object.defineProperty(e, "i", { value: !0 });
  }),
    n(752);
})();
